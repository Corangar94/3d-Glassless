...
hidden_imports = [
    *mediapipe_hiddenimports,
    ...
    "tracker.shared_settings_validation",
    ...
    "launcher.self_test",
    "launcher.utility_commands",
    "launcher.diagnostics",
    "launcher.support_bundle",
    "tracker.debug_monitor",
    "scripts.collect_support",
    "tracker.runtime_channels",
    "tracker.config_store",
    "tracker.file_transactions",
